  ...
  // --- Lijstje carousel ("N best X in Amsterdam") ---
  {
    ...
    placeholders: [
      ...
      },
      {
        name: 'kop',
        description:
          'Centered headline, 3 to 5 words, max ~34 characters, at most 2 lines. Cut it to its verb; no subtitle, no count',
      },
      {
        name: 'quote',
        description:
  ...
  // --- Agenda carousel (one event, 4 slides) ---
  {
    ...
    placeholders: [
      ...
      },
      {
        name: 'event_titel',
        description:
          'Centered headline, 3 to 5 words, max ~34 characters, at most 2 lines. Cut it to its verb — no date, no venue, no subtitle; <br> allowed',
        allowsLineBreak: true,
      },
      {
        name: 'locatie',
  ...
  // --- Gids carousel (cover + 2-8 items + CTA) ---
  {
    ...
    placeholders: [
      ...
      },
      {
        name: 'gids_titel',
        description:
          'Centered guide title, 3 to 5 words, max ~34 characters, at most 2 lines; <br> allowed to control line breaks',
        allowsLineBreak: true,
      },
      {
        name: 'gids_sub',
  ...
  // --- Lijstje editie-cover (pairs with the gids item slide) ---
  {
    ...
    placeholders: [
      { name: 'cover_image_url', description: 'Full-bleed cover photo URL', isUrl: true },
      {
        name: 'editie_titel',
        description:
          'Centered edition title, at most 2 lines, e.g. "DE BESTE HOTSPOTS VAN JULI 2026"',
      },
      {
        name: 'editie_footer',
